    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*mPlusClient =
                new PlusClient.Builder(this, this, this).setScopes(Scopes.PLUS_LOGIN,
                        Scopes.PLUS_ME).build();*/ //TODO j'ai mis en commentaire ici, le PlusClient.Builder est dépérécié, il faut passer par http://android-developers.blogspot.be/2014/02/new-client-api-model-in-google-play.html
    }
